// GF(256) exp/log tables and Reed-Solomon generator polynomials.
//
// Copied from the `qrcode` crate (v0.14.1, MIT OR Apache-2.0) so ECC bytes match
// that widely used implementation and ISO/IEC 18004 Annex A.
